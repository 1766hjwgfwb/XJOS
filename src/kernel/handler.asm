...
INTERRUPT_HANDLER 0x20, 0; keyboard interrupt
INTERRUPT_HANDLER 0x21, 0; pointing device interrupt
INTERRUPT_HANDLER 0x22, 0; clock interrupt
INTERRUPT_HANDLER 0x23, 0; com2 interrupt

INTERRUPT_HANDLER 0x24, 0; com1 interrupt
INTERRUPT_HANDLER 0x25, 0; lpt2 interrupt
INTERRUPT_HANDLER 0x26, 0; fpu interrupt

INTERRUPT_HANDLER 0x27, 0; lpt1 interrupt
INTERRUPT_HANDLER 0x28, 0; cmos clock interrupt
INTERRUPT_HANDLER 0x29, 0; rtc interrupt
INTERRUPT_HANDLER 0x2a, 0; rtc alarm interrupt
INTERRUPT_HANDLER 0x2b, 0; keyboard interrupt

INTERRUPT_HANDLER 0x2c, 0; com2 interrupt
INTERRUPT_HANDLER 0x2d, 0; lpt2 interrupt
INTERRUPT_HANDLER 0x2e, 0; fpu interrupt

INTERRUPT_HANDLER 0x2f, 0; lpt1 interrupt
